...
public class MyTreeMapMyMapInOut implements Iterable, MyMapInOutable {
    private Node root;
    private Iterator_Kind iteratorKind = Iterator_Kind.PREFIX;

    enum Iterator_Kind {INFIX, POSTFIX, PREFIX, HORIZONTAL};

    public MyTreeMapMyMapInOut(){}

    public MyTreeMapMyMapInOut(Object key, Object value){
        this.add(key, value);
    }
    ...
    public Object get(Object key) {
        Node takenNode = this.getNode(root, key);

        return (takenNode!=null) ? takenNode.getData():null;
    ...
    public Iterator<MyMapElement> iteratorMapElements() {
        return new IteratorMyMapElement();
    }

    private class IteratorMyMapElement implements Iterator<MyMapElement>{
        IteratorNode iteratorNode;
        private IteratorMyMapElement(){
            iteratorNode = new IteratorNode();
        }
    ...
    private class Node extends MyMapElement{
        Object data;
        Object key;
        Node right;
        Node left;
