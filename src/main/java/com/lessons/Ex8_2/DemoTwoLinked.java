...
public class DemoTwoLinked {
    public static void main(String[] args) throws Exception{
        System.out.println("TWO LINKED LIST DEMO");
        MyTwoLinkedList list1 = new MyTwoLinkedList();
        MyTwoLinkedList list2 = new MyTwoLinkedList();
        ...
        DemoTwoLinked.fillList(els, list1);
        DemoTwoLinked.fillList(els2, list2);
    ...
    public static void fillList(Object[] objects, List list){
